...
class GuaranteeSalaryExport extends ExportListPage {
    constructor(props) {
        super(props);
        this.state.queryParams.exportType = "GUARANTEE_SALARY_EXPORT";
        this.state.table.config = {
            column: [
                ...
                {name: "入职时间", key: "onDutyTimeAlia", textAlign: "center", width: "10%"},
                {name: "系统号", key: "userCode", textAlign: "center", width: "10%"},
                {name: "基本保障薪资", key: "guaranteeStanderSalary", textAlign: "center", width: "10%"},
                {name: "保障薪资上限", key: "guaranteeMaxSalary", textAlign: "center", width: "10%"},
            ]
        };
    }
